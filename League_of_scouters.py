...
region_filter = st.sidebar.multiselect('Filtrar por region', df_seleccionado['region'].unique())


if region_filter:
    filtered_df = df_seleccionado.loc[df_seleccionado.region == region_filter]
else:
    filtered_df = df_seleccionado
